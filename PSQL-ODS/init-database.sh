...
psql -v --no-password --tuples-only --username postgres --dbname "EdFi_Ods_Minimal_Template" --file /tmp/EdFi_Ods_Minimal_Template.sql

psql -v --no-password --tuples-only --username postgres --dbname "EdFi_Ods_Populated_Template" --file /tmp/EdFi_Ods_Populated_Template.sql
